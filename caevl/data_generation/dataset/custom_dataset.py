...
class CustomDataset(Dataset):
    ...
    def __init__(self, image_paths: list,
        ...
        mean : float, optional
            Mean for normalization. If None, and apply_normalization is True, computes the meand and std of the passed datased. Default is None.
        std : float, optional
            Standard deviation for normalization. If None, and apply_normalization is True, computes the meand and std of the passed datased. Default is None.
